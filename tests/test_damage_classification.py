...
from nmaipy.constants import AOI_ID_COLUMN_NAME, BUILDING_LIFECYCLE_ID
...
class TestDamageClassification:
    ...
    def test_flatten_damage_with_none_value(self):
        ...
        building_lifecycles = [{"damage": None}]
    ...
    def test_flatten_damage_with_scalar_value(self):
        ...
        building_lifecycles = [{"damage": 0}]  # Scalar value instead of dict
    ...
    def test_flatten_damage_with_missing_confidences(self):
        ...
        building_lifecycles = [{"damage": {"someOtherField": "value"}}]
    ...
    def test_flatten_damage_with_empty_confidences(self):
        ...
        building_lifecycles = [{"damage": {"confidences": {}}}]
    ...
    def test_feature_attributes_with_damage_primary(self):
        ...
        classes_df = pd.DataFrame({"description": ["building_lifecycle"]})
