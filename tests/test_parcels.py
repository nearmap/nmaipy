...
from nearmap_ai.constants import BUILDING_ID, LAWN_GRASS_ID, POOL_ID, VEG_MEDHIGH_ID, AOI_ID_COLUMN_NAME, API_CRS
...
class TestParcels:
    ...
    def test_large_query_geoid_11179800001006(self, cache_directory: Path):
        ...
        parcels_gdf = gpd.GeoDataFrame([{"geometry": aoi, "aoi_id": aoi_id, "since": date_1, "until": date_2}], crs=API_CRS)
